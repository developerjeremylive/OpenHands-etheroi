...
def _is_true_env_var(name: str) -> bool:
...
def _get_feature_flags() -> WebClientFeatureFlags:
    ...
    ENABLE_ACP, and OH_ENABLE_ONBOARDING from environment. ENABLE_ACP accepts
    both 'true' and '1' for compatibility with older Helm chart formats.
    """
    return WebClientFeatureFlags(
        ...
        enable_acp=_is_true_env_var('ENABLE_ACP'),
